        ...
        <div class="content">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="span16">
                        <h1>Motif <?=$title?>
                            <small>Version <?=$title?> of this group appears in releases <?=$release_id?> to
                                <?=$last_release_id?></small>
                                ...
                                <ul class="tabs">
                                    <li class="dropdown" data-dropdown="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?=$current_url?>/json" download="<?=$title?>.json">Json</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="row span1140 interactions resizable" id="interactions">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id='int'>
                            <style>
                                /* left alignment in columns of the table */
                                #int th:nth-child(2),
                                #int td:nth-child(2),
                                #int th:nth-child(6),
                                #int td:nth-child(6),
                                ...
                                .tab-pane.active th {
                                    ...
                                    vertical-align: top;   /* Aligns the header text to the top of the cell */
                                }
                            </style>
                        ...
                        <div class="tab-pane" id='variants'>
                            <h4>3D structures</h4>
                            <div class="row span100p interactions">
                                <div class="span45p">
                ...
                <div class="span4">
                    <div class="block-div resizable" id="annotation-panel">
                        <dl>
                            ...
                            <dd>
                                <strong>Min</strong> <?php echo number_format($linkage['intra_min_disc'] ?? 0, 2); ?> |
                                <strong>Avg</strong> <?php echo number_format($linkage['intra_avg_disc'] ?? 0, 2); ?> |
                                <strong>Max</strong> <?php echo number_format($linkage['intra_max_disc'] ?? 0, 2); ?>
                            </dd>
                        </dl>

                        <ul class='media-grid'>
                            <!-- use a link so there is a popup to view -->
                            <a href='#' class="hint" rel='twipsy' title='
                                ...
                                <img class="span3 thumbnail"
                                    src="<?=$baseurl?>img/MotifAtlas/<?php echo substr($title,0,2) . $last_release_id;?>/<?=$title?>.png"
                                    alt='2D diagram'>
                            </a>
                        </ul>
                        <a href="<?=config('BGSUConfig')->bgsu_url?>/help/rna-3d-hub-help" target="_blank">Help</a>
                    </div>
                </div>
                <div class="spanjmol" id="jmolBlock">
                    ...
                    <div class='showRSR' style="display:none">
                        <svg height="30" width="340">
                            ...
                            <text x="70" y="30" font-family="sans-serif" font-size="12px" fill="black">RSR Scale
                                truncated at
                                0.5</text>
                    ...
                    <div class='showRSRZ' style="display:none">
                        <svg height="45" width="340">
                            <defs>
                                <text x="120" y="0" font-family="sans-serif" font-size="12px" fill="black">RSRZ
                                    Scale</text>
                            ...
                            <text x="120" y="45" font-family="sans-serif" font-size="12px" fill="black">RSRZ
                                Scale</text>
                        </svg>
                    </div>
                    <style>
