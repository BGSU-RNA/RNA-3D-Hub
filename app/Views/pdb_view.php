      ...
      <div class="content">
        ...
        <div class="hero-unit">
            ...
            <p>
              ...
              <a href="<?=config('BGSUConfig')->fr3d_url?>">FR3D</a>
            </p>
            <p>
            ...
            <select data-placeholder="Choose one of <?php echo count($pdbs); ?> nucleic acid containing 3D structures" tabindex="1" id="chosen" style="width:350px">
             <option value=""></option>
