        ...
        <div id="help-modal" class='modal hide fade' tabindex="-1" role="dialog">
          ...
          <div class="modal-body">
            ...
            <p>
              ...
              <a href="<?=config('BGSUConfig')->bgsu_url?>/software/fr3d/">FR3D</a> annotations
            ...
            <a class="btn primary" href="<?=config('BGSUConfig')->bgsu_url?>/help/rna-3d-hub-help/interacting-with-2d-structures" target="_blank">More details</a>
          </div>
        </div>
...
<script type='text/javascript'>
    ...
    LOOP_URL = "<?=$baseurl?>loops/download/<?=$pdb_id?>";
