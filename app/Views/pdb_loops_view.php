    ...
    <div class="container pdbloopsmin pdb_loops_view">
      ...
      <div class="content">
        <div class="page-header">
          ...
          <small>Hairpin, Internal, and multi-helix Junction Loop Motifs</small>
          </h1>
        </div>
        ...
        <?php if ($valid): ?>
          ...
          <div class="span8 well">
            ...
            <ul class="pills" data-tabs="tabs">
                ...
                <li><a href="#jls"><?=$counts['J']?> Junction loops</a></li>
            </ul>
          ...
          <?php if ($counts['IL'] != 0 or $counts['HL'] != 0 or $counts['J'] != 0): ?>
