      ...
      <div class="content">
                ...
                <li class="dropdown" data-dropdown="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="<?=$baseurl?>pdb/<?=$pdb_id?>/interactions/<?=$method?>/baseribose">Base-ribose</a></li>
						        ...
						        <li><a href="<?=$baseurl?>pdb/<?=$pdb_id?>/interactions/<?=$method?>/coplanar">Coplanar</a></li>
                    <li class="divider"></li>
        ...
        <div class="row">
          <div class="span93p well">
            <div class="row">
              ...
              <div class="span10p">
                <dl>
                  ...
                  <dt>Chains</dt>
                    ...
                    <? endif; ?>
                    <?php if ($hybrid_chains > 0): ?>
                      <dd>
                        <?=$hybrid_chains?> hybrid chain<?php if ($hybrid_chains > 1): ?>s<?php endif; ?>
                      </dd>
                    <?php endif; ?>
                    <?php if ($dna_chains > 0): ?>
                      <dd>
                        <?=$dna_chains?> DNA chain<?php if ($dna_chains > 1): ?>s<?php endif; ?>
                      <dd>
                    <?php endif; ?>
                    <?php if ($pna_chains > 0): ?>
                      <dd>
                        <?=$pna_chains?> PNA chain<?php if ($pna_chains > 1): ?>s<?php endif; ?>
                      <dd>
                    <?php endif; ?>
                    <dd>
                    <?=$non_na_chains?> other chain<?php if ($non_na_chains != 1): ?>s<?php endif; ?>
                    </dd>
                </dl>
              </div>
              ...
              <div class="span45p">
                <dl>
                  <dt>Nucleic acid compounds</dt>
                  <dl><?=$na_compounds?></dl>
                  <dt>Other compounds</dt>
                  <dl><?=$non_na_compounds?>
                </dl>
              </div>
            </div> <!-- end row -->
        ...
        <div class="row">
              ...
              <div class="span20p well">
                ...
                Interactions annotated by <a href="<?=config('BGSUConfig')->fr3d_url?>">FR3D</a>:
                <ul>
              ...
              <div class="span20p well">
                ...
                <ul>
                  ...
                  <li>
                    <?=$loops['J']?> junction loop<?php if ($loops['J'] <> 1): ?>s<?php endif; ?>
                    from <?=$j_counts?> motif group<?php if ($j_counts <> 1): ?>s<?php endif; ?>
                  </li>
                </ul>
                <?=$loops['url']?>
              </div>
