    ...
    <div class="container home">
      ...
      <div class="hero-unit">
        ...
        <p>
          ...
          The RNA 3D Motif Atlas organizes hairpin, internal, and 3-way junction loops by their geometry.
        </p>
        <p>
      ...
      <div class="row">
        ...
        <div class="span30p">
          ...
          <p>An collection of RNA 3D hairpin, internal, and 3-way junction loops extracted from a
            representative set of structures and organized into geometrically coherent groups.
        ...
        <div class="span30p">
          ...
          <p><a class="btn primary" href="<?php echo $baseurl;?>nrlist/dna">Explore DNA</a> - Experimental, starting in 2011</p>
       </div>
