...
class Nrlist extends CI_Controller {
    ...
    #public function view($id, $nr_release_id)
    {
        ...
        // $counter = 0;
        // $pattern = '#<a class="pdb">([^<]+)<\/a>#';
        // foreach ($statistics as &$row) {
        //     // array_unshift($row, "<input type='checkbox' id='$counter'  class='jmolInline' data-coord='$row[1]</label>/>");
        //     // print_r($row[1]);
        //     // $ife_name = strval($row[1]);
        //     // print_r($ife_name);
        //     // if (preg_match($pattern, $row[1], $matches)){
        //     //     print_r($row[1]);
        //     //     $ife_name = $matches[1];
        //     // }
        //     $row[1] = "<input type='checkbox' id='$counter' data-coord='11111111' class='jmolInline'".$row[1];
        //     // print_r($row[1]);
        //     // $row[0] = "<input type='checkbox' id='$counter' class='jmolInline' <td>$row[0]</td>>";
        //     $counter = $counter+1;
        // }
        // unset($row); 
        ...
        ## the followig commented lines can be removed
        // $counter = 0;
        // # try to find ife values
        // $pattern = '/title="([^"]+)"/';
        // foreach ($revised_stat as &$line) {
        //     ## check if we have ife ids. ife_check will be 1 if we got it.
        //     $ife_check = preg_match($pattern, $line[1], $matches);
        //     $ife_name_revised = $matches[1];
        //     $row[1] = "<input type='checkbox' id='$counter' >";
        //     $counter = $counter+1;
        // }
        // unset($line); 
        // $data['statistics'] = $revised_stat;
